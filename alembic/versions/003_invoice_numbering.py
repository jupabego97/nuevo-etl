...
def downgrade() -> None:
    settings = get_settings()
    schema = settings.db_schema
    op.drop_index("ix_fact_sales_invoice_is_electronic", table_name="fact_sales_invoice", schema=schema)
    op.drop_index("ix_fact_sales_invoice_number_prefix", table_name="fact_sales_invoice", schema=schema)
    op.drop_index("ix_fact_sales_invoice_number_template_id", table_name="fact_sales_invoice", schema=schema)
    op.drop_column("fact_sales_invoice", "cufe", schema=schema)
    op.drop_column("fact_sales_invoice", "is_electronic", schema=schema)
    op.drop_column("fact_sales_invoice", "number_value", schema=schema)
    op.drop_column("fact_sales_invoice", "number_prefix", schema=schema)
    op.drop_column("fact_sales_invoice", "number_template_name", schema=schema)
    op.drop_column("fact_sales_invoice", "number_template_id", schema=schema)
