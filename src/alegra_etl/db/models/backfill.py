...
class BackfillWorkItem(Base, TimestampMixin):
    ...
    api_records: Mapped[int | None] = mapped_column(Integer)
    api_distinct_ids: Mapped[int | None] = mapped_column(Integer)
    source_distinct_ids: Mapped[int | None] = mapped_column(Integer)
    typed_distinct_ids: Mapped[int | None] = mapped_column(Integer)
